...
export const Toolbar = forwardRef(({ children, className, variant = "fixed", ...props }, ref) => {
	...
	return (
		<div ref={composedRef} role="toolbar" aria-label="toolbar" data-variant={variant} className={cn("tiptap-toolbar rounded-lg", className)} {...props}>
			{children}
		</div>
	);
});
...
export const ToolbarSeparator = forwardRef(({ ...props }, ref) => <Separator ref={ref} orientation="vertical" decorative {...props} />);
