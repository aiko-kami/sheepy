...
import "@/components/Tiptap/tiptap-ui-primitive/card/card.scss";
...
const CardItemGroup = forwardRef(({ className, orientation = "vertical", ...props }, ref) => {
	return <div ref={ref} data-orientation={orientation} className={cn("tiptap-card-item-group", className)} {...props} />;
});
