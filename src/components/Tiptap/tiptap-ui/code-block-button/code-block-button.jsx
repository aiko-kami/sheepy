...
import { CODE_BLOCK_SHORTCUT_KEY, useCodeBlock } from "@/components/Tiptap/tiptap-ui/code-block-button";
 ...
 */
export const CodeBlockButton = forwardRef(({ editor: providedEditor, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }, ref) => {
