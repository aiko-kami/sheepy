...
import { IMAGE_UPLOAD_SHORTCUT_KEY, useImageUpload } from "@/components/Tiptap/tiptap-ui/image-upload-button";
...
export const ImageUploadButton = forwardRef(
	({ editor: providedEditor, text, hideWhenUnavailable = false, onInserted, showShortcut = false, onClick, icon: CustomIcon, children, ...buttonProps }, ref) => {
