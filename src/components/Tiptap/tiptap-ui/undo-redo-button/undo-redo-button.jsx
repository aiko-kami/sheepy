...
import { UNDO_REDO_SHORTCUT_KEYS, useUndoRedo } from "@/components/Tiptap/tiptap-ui/undo-redo-button";
 ...
 */
export const UndoRedoButton = forwardRef(({ editor: providedEditor, action, text, hideWhenUnavailable = false, onExecuted, showShortcut = false, onClick, children, ...buttonProps }, ref) => {
