...
import { BLOCKQUOTE_SHORTCUT_KEY, useBlockquote } from "@/components/Tiptap/tiptap-ui/blockquote-button";
 ...
 */
export const BlockquoteButton = forwardRef(({ editor: providedEditor, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }, ref) => {
