...
// --- UI Utils ---
import { findNodePosition, isNodeInSchema, isNodeTypeSelected, isValidPosition, selectionWithinConvertibleTypes } from "@/lib/tiptap-utils";
 ...
 */
export function canToggleBlockquote(editor, turnInto = true) {
	...
	if (!selectionWithinConvertibleTypes(editor, ["paragraph", "heading", "bulletList", "orderedList", "taskList", "blockquote", "codeBlock"])) return false;
 ...
 * ```
 */
export function useBlockquote(config) {
