...
import { COLOR_HIGHLIGHT_SHORTCUT_KEY, useColorHighlight } from "@/components/Tiptap/tiptap-ui/color-highlight-button";
...
export const ColorHighlightButton = forwardRef(
	({ editor: providedEditor, highlightColor, text, hideWhenUnavailable = false, mode = "mark", onApplied, showShortcut = false, onClick, children, style, ...buttonProps }, ref) => {
