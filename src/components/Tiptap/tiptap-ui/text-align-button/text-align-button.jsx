...
import { TEXT_ALIGN_SHORTCUT_KEYS, useTextAlign } from "@/components/Tiptap/tiptap-ui/text-align-button";
...
export const TextAlignButton = forwardRef(
	({ editor: providedEditor, align, text, hideWhenUnavailable = false, onAligned, showShortcut = false, onClick, icon: CustomIcon, children, ...buttonProps }, ref) => {
