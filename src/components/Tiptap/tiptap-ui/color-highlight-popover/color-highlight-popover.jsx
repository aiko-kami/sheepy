...
import { ColorHighlightButton, pickHighlightColorsByValue, useColorHighlight } from "@/components/Tiptap/tiptap-ui/color-highlight-button";

export const ColorHighlightPopoverButton = forwardRef(({ className, children, ...props }, ref) => (
	<Button type="button" className={className} data-style="ghost" data-appearance="default" role="button" tabIndex={-1} aria-label="Highlight text" tooltip="Highlight" ref={ref} {...props}>
