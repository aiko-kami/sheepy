		...
		<>
			<div className="flex h-full m-auto">
				<div className="group relative">
					<button className="inline-flex items-center px-6 py-1.5 tn:m-2">
						Start
				...
				<Link href="/login" className="inline-flex items-center duration-200 active:text-base-450 px-6 py-1.5 tn:m-2">
					Discover
				</Link>
				<Link href="/login" className="inline-flex items-center duration-200 active:text-base-450 px-6 py-1.5 tn:m-2">
					Search
