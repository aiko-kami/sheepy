	...
	return (
		<div className="relative z-0 mb-6 w-full">
			...
			<input
				...
				value={inputValue}
				onChange={onChange}
				className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-600 appearance-none focus:outline-none hover:shadow-lg focus:ring-0 focus:border-blue-500 peer"
				placeholder=" "
			/>
			<label
				htmlFor={label}
