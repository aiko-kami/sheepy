...
const ObjectivesList = ({ objectives = [], handleRemoveObjective }) => {
			...
			<AnimatePresence>
				{objectives.map((objective, index) => (
					<motion.div
						...
						layout
						className="flex items-center justify-between px-3 pt-1 pb-1.5 mt-1 rounded-2xl bg-purple-100 text-purple-800 border border-purple-200 shadow-sm"
					>
						{objective}
						<button
							type="button"
