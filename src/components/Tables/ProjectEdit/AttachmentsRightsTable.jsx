...
const AttachmentsRightsTable = ({ members, projectId, projectPermissions }) => {
	const headers = ["view document", "add document", "edit document", "remove document"];
	return (
		<>
			<table className="text-xs md:text-sm shadow-lg">
				<thead className="bg-gray-700 text-gray-300">
					<tr>
						...
						<th colSpan={headers.length} scope="col" className="font-normal text-center md:px-4 py-1">
							Can update attachments...
						</th>
					</tr>
					<tr>
						{headers.map((header, index) => (
							<th key={index} scope="col" className="font-normal text-center p-2 md:pb-3 md:px-3 text-xs w-32">
...
export default AttachmentsRightsTable;
