...
const GeneralRightsTable = ({ members, projectId, projectPermissions }) => {
	const headers = ["title", "category", "sub-category", "summary", "description", "goal", "cover", "tags"];
	return (
		<>
				...
				<thead className="bg-gray-700 text-gray-300">
					...
					<tr>
						{headers.map((header, index) => (
							<th key={index} scope="col" className="font-normal text-center p-2 md:pb-3 md:px-3 text-xs w-24">
...
export default GeneralRightsTable;
