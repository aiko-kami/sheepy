...
const JoinProjectTable = ({ joinProjects, type }) => {
	return (
		<>
			<table className="table-fixed w-full text-xs md:text-sm shadow-lg text-gray-300">
				<thead className="uppercase bg-gray-700 text-gray-200">
					<tr>
						<th scope="col" className="text-center p-2 md:px-4 md:py-3">
							Project title
						</th>
						<th scope="col" className="text-center p-2 md:px-4 md:py-3 hidden lg:table-cell">
							Category
						</th>
						<th scope="col" className="text-center p-2 md:px-4 md:py-3 hidden lg:table-cell">
							Talent
