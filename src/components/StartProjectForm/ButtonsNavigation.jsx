	...
	return (
		<>
			<div className="flex items-center">
				<div className="flex">
					{currentStep === 1 && (
						<Button btnProps={{ btnSize: "std", type: "button", btnColor: "blue", btnRounded: "std", action: () => goToStep(0) }}>
							<div className="flex">
					...
					{currentStep > 1 && (
						<Button btnProps={{ btnSize: "std", type: "button", btnColor: "blue", btnRounded: "std", action: () => goToStep(currentStep - 1) }}>
							<div className="flex">
				...
				<div className="flex gap-2 ml-auto">
					<Button btnProps={{ btnSize: "std", type: "button", btnColor: "grayBorder", btnRounded: "std", action: () => goToStep(0) }}>
					...
					{currentStep === totalSteps - 1 && (
						<Button btnProps={{ btnSize: "std", type: "button", btnColor: "blue", btnRounded: "std", action: () => goToStep(totalSteps) }}>
							<div className="flex">
					...
					{currentStep === totalSteps && (
						<Button btnProps={{ btnSize: "std", type: "button", btnColor: "blue", btnRounded: "std", action: () => goToStep(totalSteps + 1) }}>
							<div className="flex">
