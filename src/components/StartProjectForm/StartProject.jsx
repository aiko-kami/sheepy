...
const StartProject = async ({ goToStep }) => {
	const { user } = useAuth();
		...
		<div className="flex items-center justify-center">
			<div className="max-w-4xl mx-auto text-center">
				...
				{user ? (
					...
					<h1 className="text-4xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-600 leading-[2.15] pt-4 pb-6">Join Our Community</h1>
				)}
