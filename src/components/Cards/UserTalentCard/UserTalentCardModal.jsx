	...
	return (
		<>
			<div
				id="default-modal"
				tabIndex="-1"
				className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black bg-opacity-25 backdrop-blur-sm"
			>
						...
						<div className="px-4 md:px-5 pb-8">
							...
							<div className="space-y-4">
								...
								<div>
									...
									<p className="leading-relaxed text-gray-300">
										Provided UX consulting services to small businesses and startups, offering expertise in user research, usability testing, and interface design. Led workshops and training sessions
										to educate clients on UX principles and methodologies. Developed user personas, user flows, and wireframes to guide product development processes. Conducted heuristic evaluations
										and accessibility audits to identify areas for improvement. Collaborated with development teams to implement design solutions and ensure a seamless user experience across web and
										mobile platforms.
									</p>
								</div>
							</div>
