			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-6 my-4">
				<div className="col-span-2 md:row-span-2">
					<div className="relative w-full">
						...
						<Link href="/project/01">
							<span className="absolute top-2 right-2 text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 hover:bg-blue-500 text-white rounded">
								Culture
							</span>
						</Link>
					</div>
					<Link href="/project/01" className="">
				...
				<div className="col-span-2 flex h-32 lg:h-40 xl:h-48">
					<div className="w-2/5 relative">
						...
						<Link href="/project/01" className="">
							<span className="absolute top-2 right-2 text-xs inline-block ml-2 py-1 px-2 leading-none text-center whitespace-nowrap align-baseline font-bold bg-green-600 hover:bg-green-500 text-white rounded">
								Nature
							</span>
						</Link>
					</div>
					<Link href="/project/01" className="w-3/5">
				...
				<div className="col-span-2 flex h-32 lg:h-40 xl:h-48">
					<div className="w-2/5 relative">
						...
						<Link href="/project/01" className="">
							<span className="absolute top-2 right-2 text-xs inline-block ml-2 py-1 px-2 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 hover:bg-red-500 text-white rounded">
								Video Games
							</span>
						</Link>
					</div>
				...
				<div className="relative h-32 lg:h-40 xl:h-48">
					...
					<Link href="/project/01">
						<span className="absolute top-2 right-2 text-xs inline-block py-1 px-2 leading-none text-center whitespace-nowrap align-baseline font-bold bg-black hover:bg-gray-800 text-white rounded">
							Art
						</span>
					</Link>
					<Link href="/project/01" className="absolute bottom-1.5 left-2 m-1">
				...
				<div className="relative h-32 lg:h-40 xl:h-48">
					...
					<Link href="/project/01">
						<span className="absolute top-2 right-2 text-xs inline-block py-1 px-2 leading-none text-center whitespace-nowrap align-baseline font-bold bg-purple-800 hover:bg-purple-500 text-white rounded">
							Music
						</span>
					</Link>
				...
				<div className="col-span-2 flex h-32 lg:h-40 xl:h-48">
					<div className="w-2/5 relative">
						...
						<Link href="/project/01" className="">
							<span className="absolute top-2 right-2 text-xs inline-block ml-2 py-1 px-2 leading-none text-center whitespace-nowrap align-baseline font-bold bg-pink-600 hover:bg-pink-500 text-white rounded">
								LGBT
							</span>
						</Link>
					</div>
