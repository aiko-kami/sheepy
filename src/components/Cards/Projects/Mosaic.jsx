			...
			<div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
				<div className="lg:col-span-2 relative h-50 lg:h-70 xl:h-100">
					...
					<div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/90 to-black/0">
						...
						<Link href={`/projects/${selectedProjects[0].projectId}`} className="absolute bottom-1.5 left-2 m-1 md:max-w-4/5">
				...
				<div className="relative h-50 lg:h-70 xl:h-100">
					...
					<div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/90 to-black/0">
						...
						<Link href={`/projects/${selectedProjects[1].projectId}`} className="absolute bottom-1.5 left-2 m-1">
				...
				<div className="relative h-50 lg:h-70 xl:h-100">
					...
					<div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/90 to-black/0">
						...
						<Link href={`/projects/${selectedProjects[2].projectId}`} className="absolute bottom-1.5 left-2 m-1">
				...
				<div className="lg:col-span-2 relative h-50 lg:h-70 xl:h-100">
					...
					<div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/90 to-black/0">
						...
						<Link href={`/projects/${selectedProjects[3].projectId}`} className="absolute bottom-1.5 right-2 text-right m-1 md:max-w-4/5">
				...
				{selectedProjectsCategories.map((projectsCat, index) => (
					<div>
						...
						<div className="mb-6 relative h-100">
							<Link href={`/projects/${projectsCat.projects[0].projectId}`}>
