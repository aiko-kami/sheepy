...
const Footer = () => {
	...
	return (
		<>
			<footer className="sticky top-[100vh] mt-12 border-t border-white/10 bg-base-600 backdrop-blur-sm">
				<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:pt-12 lg:pb-8">
