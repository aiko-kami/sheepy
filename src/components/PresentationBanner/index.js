			...
			<div className="my-12">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 container mx-auto">
					<div className="mt-6 mx-2 flex flex-col items-center">
						...
						<p className="text-center text-indigo-500 w-44">Let us help you build up your next idea.</p>
					</div>

					<div className="mt-6 mx-2 flex flex-col items-center">
						<Image src={award} alt="award-badge" />
						<h3 className="text-lg text-center ">Put your skills into practice</h3>
						<p className="text-center text-indigo-500 w-52">Help people looking for your talent and improve your skills by joining a project.</p>
					</div>

					<div className="mt-6 mx-2 flex flex-col items-center">
						<Image src={conversation} alt="conversation-badge" />
						<h3 className="text-lg text-center">Work as a team</h3>
						<p className="text-center text-indigo-500 w-56">
					...
					<div className="mt-6 mx-2 flex flex-col items-center">
						...
						<p className="text-center text-indigo-500 w-48">The most important thing is to do what you like!</p>
					</div>
				</div>
			</div>
		</>
