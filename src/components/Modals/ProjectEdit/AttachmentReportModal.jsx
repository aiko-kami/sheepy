...
const AttachmentReportModal = ({ closeModalReport, request }) => {
	...
	return (
		<>
			...
			<form onSubmit={onSubmit}>
				...
				{/* Report validation */}
				<h2 className="text-lg font-semibold text-center mb-6">Are you sure you want to report this request to join the project?</h2>
