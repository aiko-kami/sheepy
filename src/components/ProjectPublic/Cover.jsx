		...
		<>
			<div className="relative mb-3 w-full h-50 sm:h-60 md:h-110 rounded-xl overflow-hidden">
				...
				{coverLink && coverLink !== "" ? (
					...
					<svg viewBox="0 0 66.854 66.854" color="#2C3F5C" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 w-full h-full object-cover py-14 bg-gray-200">
						<path
							fill="currentColor"
				...
				<div className="relative z-10 h-full flex flex-col mx-0 p-2 pb-3 sm:p-4">
					<div className="mt-auto">
						{/* Title */}
						<h1 className="text-xl sm:text-4xl md:text-6xl font-semibold mb-3 sm:mb-5">{title}</h1>
